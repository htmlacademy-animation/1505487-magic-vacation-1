...
class FullPageScroll {
  ...
  changeVisibilityDisplay() {
    this.screenElements.forEach((screen) => {
      ...
      screen.classList.remove(`active`, `show-controls`);
    });
...
/***/ "./source/js/modules/text-ani-maker.js":
/*!*********************************************!*\
  !*** ./source/js/modules/text-ani-maker.js ***!
  \*********************************************/
/*! exports provided: getOffsetDefault, getOffsetSinFn, AnimationSettings, TextAniMaker */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getOffsetDefault", function() { return getOffsetDefault; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getOffsetSinFn", function() { return getOffsetSinFn; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AnimationSettings", function() { return AnimationSettings; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TextAniMaker", function() { return TextAniMaker; });
const getOffsetDefault = (num) => Math.round(Math.sin(num * Math.PI / 1.5) + num) * 70;
const getOffsetSinFn = (num) => Math.round(Math.sin(num * Math.PI / 1.5)) * 100;
...
/* harmony import */ var _modules_text_ani_maker__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/text-ani-maker */ "./source/js/modules/text-ani-maker.js");
// modules
...
function init() {
  ...
  const animationSettings = new _modules_text_ani_maker__WEBPACK_IMPORTED_MODULE_9__["AnimationSettings"]();
  const taglineTransformer = new _modules_text_ani_maker__WEBPACK_IMPORTED_MODULE_9__["TextAniMaker"](document.querySelector(`.intro__title`), animationSettings);
  const dateTransformer = new _modules_text_ani_maker__WEBPACK_IMPORTED_MODULE_9__["TextAniMaker"](document.querySelector(`.intro__date`), animationSettings);
